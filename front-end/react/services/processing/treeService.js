 ...
 * @param {type} data.oldStore the store to add the raw keys to
 * @param {type} data.oldChildData the accumulator for the child array 
 ...
 * @returns {undefined}
 */
addKeys:  function(categoryData,data)
{
    ...
    var newStore = this.clone(oldStore);
